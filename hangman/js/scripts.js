var wordLists = { 
  "countries" : ["argentina", "australia", "brazil", "belgium", "canada", "chile", "china", "denmark", "egypt", "france", "germany", "honduras", "indonesia", "italy", "japan", "kenya", "madagascar", "maldives", "netherlands", "oman", "russia", "switzerland", "tanzania", "ukraine", "venezuela", "yemen", "zambia"],
  "food": ["almond", "apple", "bacon", "beef", "caviar", "cilantro", "dairy", "digest", "edible", "entree", "fillet", "frosting", "gastronomy", "guacamole", "halibut", "honeydew", "icing", "jackfruit", "kumquat", "legumes", "licorice", "meringue", "molasses", "nutmeg", "okra", "parsnip", "quiche", "risotto", "spinach", "turnip", "utensils", "venison", "wok", "yeast", "zucchini"],
  "human": ["abdomen", "bladder", "buttocks", "cartilage", "clavicle", "coccyx", "diaphragm", "elbow", "esophagus", "fibula", "follicle", "gallbladder", "humerus", "iris", "jaw", "kidney", "larynx", "liver", "mandible", "molar", "navel", "ovary", "patella", "pituitary", "radius", "rectum", "ribs", "sacrum", "scapula", "spleen", "tendon", "tissue", "ulna", "uvula", "vein", "wrist"]
};
